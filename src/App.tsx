...
const FeaturedStores = [
  ...
  },
  {
    ...
    reason:
      "店内酥点结合了历史传承、非遗技艺和宋式美学。制作工艺精湛，外观简约典雅，口感细腻丰富",
  },
  {
    id: 3,
    name: "四季民福烤鸭店",
    ...
    <div className="w-full flex flex-col items-center px-4">
      ...
      <div className="relative w-[340px] rounded-[24px] shadow-[0_12px_32px_rgba(0,0,0,0.12)] flex flex-col border border-gray-100/50 bg-white z-20 shrink-0">
        ...
        <div className="relative shrink-0">
          <img
            src={store.img}
            className="w-full h-[120px] object-cover rounded-t-[24px]"
            alt={store.name}
          />
          {/* Badge */}
        ...
        <div className="px-4 py-3 relative bg-white rounded-b-[24px] flex-1 flex flex-col">
          <div className="flex justify-between items-center mb-1">
            <h2 className="text-[17px] font-bold text-gray-900 leading-tight truncate pr-2">
              {store.name}
            </h2>
          ...
          <div className="flex items-center text-[11px] text-gray-500 mb-2 space-x-2 shrink-0">
            ...
            <span className="bg-gray-100 px-1 py-0.5 rounded font-medium">
              月售{store.sales}
            </span>
          ...
          {(store as any).signatureDish && (
            <div className="flex items-center mb-2 shrink-0">
              <div className="inline-flex items-center rounded-md overflow-hidden shadow-[0_2px_8px_rgba(255,140,0,0.15)] border border-orange-100">
                <span className="bg-gradient-to-r from-[#FF7A45] to-[#FF4D4F] text-white text-[10px] font-bold px-1.5 py-0.5 shrink-0 flex items-center">
                  <Star size={8} fill="currentColor" className="mr-0.5" />{" "}
                  本店招牌
                </span>
                <span className="bg-gradient-to-r from-[#FFF0D4] to-[#FFE599] text-[#8C5A2A] text-[10px] font-bold px-2 py-0.5 shrink-0 flex items-center">
                  {(store as any).signatureDish}
                </span>
              </div>
            </div>
  ...
  return (
    <div className="w-full h-full bg-[#160f24] rounded-[24px] flex flex-col p-3 shadow-inner relative overflow-hidden">
      ...
      <div className="flex items-center gap-2 mb-2 relative z-10 shrink-0">
        <div className="w-6 h-6 rounded-full bg-gradient-to-tr from-[#FF5C5C] to-[#FFD161] flex items-center justify-center font-bold text-white text-[10px] shadow-[0_0_8px_rgba(255,92,92,0.5)]">
          本地
        </div>
        <span className="text-[14px] font-bold text-[#FFD161] drop-shadow-md tracking-wider">
          土著深夜充电好去处
        </span>
      </div>
        ...
        <div className="flex flex-col gap-2 overflow-y-auto hide-scrollbar w-full h-full pb-2">
          {aiRestaurants.map((r, i) => {
            ...
            return (
              <div
                key={i}
                className="flex gap-2 items-center bg-white/10 rounded-xl p-1.5 border border-white/10 relative z-10 w-full shrink-0"
              >
                {showImage ? (
                  <img
                    src={r.img}
                ...
                <div className="flex flex-col flex-1 pr-1 overflow-hidden h-full justify-center">
                  <div className="flex justify-between items-center whitespace-nowrap">
                    ...
                    {showScore && (
                      <span className="text-[10px] font-black text-[#FFD161] bg-[#FFD161]/20 px-1 rounded">
                        {r.score}
                      </span>
                    )}
                  </div>
...
export default function App() {
  ...
  const [activeTab, setActiveTab] = useState<"plan1" | "plan2" | "plan3">(
    "plan1",
  );
  ...
  const featuredStoresToUse =
    activeTab === "plan1" || activeTab === "plan3"
      ? FeaturedStores
      : FeaturedStores.filter((s) => !(s as any).isAiCard);
    ...
    <div className="bg-gray-200 min-h-screen flex justify-center font-sans">
      ...
      <div className="bg-[#f0f0f5] w-[375px] h-[812px] relative overflow-hidden flex flex-col shadow-2xl overflow-y-auto hide-scrollbar">
        ...
        <div className="flex-1 overflow-y-auto hide-scrollbar pb-[80px]">
          ...
          <div className="relative pt-4 pb-2 px-3 bg-[#160f24] overflow-hidden rounded-b-[24px] shadow-[0_4px_15px_rgba(22,15,36,0.1)] mb-1">
            ...
            <div className="relative z-20 w-full mt-2">
              <div className="bg-white/95 backdrop-blur-xl h-[38px] rounded-full shadow-[0_8px_25px_rgba(0,0,0,0.2)] flex items-center border border-white/30 overflow-hidden group hover:bg-white transition-colors">
                <Search
                  className="text-gray-400 ml-3.5 shrink-0 group-hover:text-[#FF9E00] transition-colors"
                  size={16}
                />
                <input
                  type="text"
          ...
          <div className="pl-3 pt-2 pb-1 overflow-hidden">
            <div className="flex gap-[17px] overflow-x-auto hide-scrollbar pr-3">
              {KingKongCategories.map((cat, idx) => (
                <div
                  key={idx}
                  className="flex flex-col items-center cursor-pointer group w-[44px] shrink-0"
                >
                  <div
                    className={`w-[44px] h-[44px] rounded-[16px] ${cat.color} flex items-center justify-center text-[22px] mb-1 shadow-sm group-hover:scale-105 transition-transform`}
                  >
                    {cat.icon}
                  </div>
            ...
            {activeTab === "plan3" ? (
              ...
              <motion.div
                animate={{
                  height:
                    (
                      featuredStoresToUse[
                        ((activeStoreIndex % featuredStoresToUse.length) +
              ...
              >
                {[-2, -1, 0, 1, 2].map((offset) => {
                  ...
                  const dataIndex =
                    ((virtualIndex % featuredStoresToUse.length) +
                      featuredStoresToUse.length) %
                    featuredStoresToUse.length;
                  ...
                  return (
                    <motion.div
                      ...
                      animate={{
                        height:
                          isActive && (store as any).isAiCard && isAiExpanded
                            ? 380
                            : 310,
                        x: isActive
                          ? 0
                    ...
                    >
                      ...
                      {!isActive && (
                        <div className="absolute inset-0 bg-white/40 z-50 pointer-events-none" />
                      )}
              ...
              <div className="w-full px-2 -mt-4 mb-4 relative z-10 flex flex-col items-center">
                  ...
                  {StoreList.slice(0, 5).map((s, i) => (
                    ...
                    >
                      ...
                      <div className="relative shrink-0">
                        <img
                          src={s.img}
                          className="w-[100px] h-[100px] rounded-xl object-cover shadow-[0_2px_8px_rgba(0,0,0,0.1)]"
                          alt=""
                        />
                      ...
                      <div className="flex flex-col flex-1 min-w-0 py-0.5 relative z-10">
                        <div className="text-[16px] font-extrabold text-gray-900 truncate mb-1.5 pr-2">
                          {s.name}
                        </div>
                        <div className="flex items-center text-[11px] text-gray-500 mb-2 gap-2">
                          ...
                          <span className="bg-gray-100/80 px-1.5 py-0.5 rounded text-gray-500 font-medium border border-gray-200/50">
                            月售{s.sales}
                          </span>
                        </div>

                        {(s as any).signatureDish && (
                          <div className="mb-2 shrink-0">
                            <div className="inline-flex items-center rounded-md overflow-hidden shadow-[0_2px_8px_rgba(255,140,0,0.15)] border border-orange-100">
                              <span className="bg-gradient-to-r from-[#FF7A45] to-[#FF4D4F] text-white text-[9px] font-bold px-1.5 py-0.5 shrink-0 flex items-center">
                                <Star
                                  size={8}
                                  fill="currentColor"
                                  className="mr-0.5"
                ...
                >
                  <div className="flex items-center justify-center gap-1.5 text-gray-900 font-extrabold text-[15px] z-20">
                    <span className="drop-shadow-[0_1px_2px_rgba(255,255,255,1)] tracking-widest">
                      {isPlan2Expanded
                        ? "收起神秘夜宵榜单"
                        : "点击展开 10 家精选夜宵"}
                    </span>
                    <ChevronDown
                      size={18}
                      className={`transition-transform duration-300 drop-shadow-sm ${isPlan2Expanded ? "rotate-180" : "group-hover:translate-y-1"}`}
                    />
                  </div>
          ...
          <div
            ref={listRef}
            className="sticky top-0 bg-[#f5f5f5] z-30 pt-0 pb-2 px-3 shadow-[0_10px_10px_-10px_rgba(0,0,0,0.05)]"
          >
            ...
            <div className="flex gap-2 overflow-x-auto hide-scrollbar text-[12px] pb-1 px-1">
              ...
              >
                <div
                  className={`mr-1 flex items-center justify-center rounded-sm w-3.5 h-3.5 text-[9px] font-bold ${activeFilter === "red_packet" ? "bg-red-600 text-white" : "bg-red-100 text-red-500"}`}
                >
                  ¥
                </div>
                可用红包
          ...
          <div className="px-3 pb-4 space-y-2.5">
            {filteredStores.map((store) => (
              <div
                key={store.id}
                className="bg-white p-3 rounded-2xl shadow-sm flex gap-3 relative cursor-pointer hover:shadow-md transition-shadow"
              >
                {/* Left: Image */}
                ...
                <div className="flex-1 min-w-0 pr-2">
                  ...
                  <div className="flex justify-between items-center text-[11px] text-gray-500 mb-2">
                    <span className="truncate pr-2 border-r border-gray-200">
                      起送 ¥{store.deliveryStart}{" "}
                    ...
                    <div className="shrink-0 text-right pl-2">
                      ...
                      <span className="mx-1"></span> {store.distance}
                    </div>
                  </div>

                  {(store as any).signatureDish && (
                    <div className="mb-2">
                      <span className="inline-flex items-center rounded-md overflow-hidden shadow-[0_1px_3px_rgba(255,140,0,0.1)] border border-orange-100/50">
                        <span className="bg-gradient-to-r from-[#FF7A45] to-[#FF4D4F] text-white text-[9px] font-bold px-1 py-0.5 shrink-0 flex items-center">
                          特色
                        </span>
                        <span className="bg-gradient-to-r from-[#FFF0D4] to-[#FFE599] text-[#8C5A2A] text-[10px] font-bold px-1.5 py-0.5 shrink-0 flex items-center">
                          {(store as any).signatureDish}
                        </span>
                      </span>
                    </div>
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {store.redPacketUsable && (
                      <div className="border border-red-200 text-red-500 px-1.5 py-0.5 rounded-[4px] text-[10px] font-medium flex items-center">
                        <div className="bg-red-500 text-white text-[8px] px-1 rounded-sm mr-1">
                          红包
                        </div>
                        可用8元红包
                      </div>
                    ...
                    {store.rank && (
                      <div className="bg-[#FEF5E5] text-[#D88921] px-1.5 py-0.5 rounded-[4px] text-[10px] font-medium flex items-center">
                        <span className="bg-[#D88921] text-white rounded-full w-3 h-3 flex items-center justify-center mr-1 text-[8px] transform scale-90">
                          榜
                        </span>
                        {store.rank}{" "}
                    ...
                    {store.tags.map((tag, i) => (
                      <div
                        key={i}
                        className="border border-gray-200 text-gray-500 px-1.5 py-0.5 rounded-[4px] text-[10px]"
                      >
                        {tag}
                      </div>
                    ))}
        ...
        {activeTab === "plan2" && (
          <motion.div
            ...
            onDragStart={() => {
              (window as any).isDraggingRedPacket = true;
            }}
            onDragEnd={() => {
              setTimeout(() => {
                (window as any).isDraggingRedPacket = false;
              }, 100);
            }}
          ...
          >
            ...
            >
              ...
              <div className="w-full h-full bg-gradient-to-b from-[#FF5C5C] to-[#E32323] rounded-[14px] border border-[#FF8F8F] flex flex-col items-center justify-center relative overflow-hidden">
                ...
                >
                  <span className="text-[#D0021B] font-bold text-[10px]">
                    神券
                  </span>
                </motion.div>
                ...
                <motion.div
                  animate={
                    redPacketAnim
                      ...
                      : { y: 0, x: 0, opacity: 0, scale: 0.5, rotate: 0 }
                  }
                ...
                <motion.div
                  animate={
                    redPacketAnim ? { opacity: [1, 0, 0, 1] } : { opacity: 1 }
                  }
                  transition={{ duration: 2.5, times: [0, 0.2, 0.8, 1] }}
                ...
                ></motion.div>
                <span className="text-[#FFDE73] font-black text-[22px] leading-none mt-5 drop-shadow-md relative z-10">
                  ¥8
                </span>
              </div>
            </motion.div>
